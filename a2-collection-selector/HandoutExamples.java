...
public class HandoutExamples {
   ...
   static Collection<Integer> newColl = Arrays.<Integer>asList(new Integer[]{-2147483648});
   static Collection<Integer> newColl2 = Arrays.<Integer>asList(new Integer[]{-4,-4});
   static Collection<Integer> newColl3 = Arrays.<Integer>asList(new Integer[]{-4,-4,-4,-4});
   static Collection<Integer> oneValColl = Arrays.<Integer>asList(new Integer[]{2147483647});
   static Collection<Integer> twoValColl = Arrays.<Integer>asList(new Integer[]{4,4});
   static Collection<Integer> lastCase = Arrays.<Integer>asList(new Integer[]{1,3,5,7,9});
   ...
   public static void kmaxExamples() {
      ...
      System.out.println("NEW SECTION STARTED");
      //System.out.println(Selector.<Integer>kmax(c1, 0, ascendingInteger));
      //System.out.println(Selector.<Integer>kmax(newColl, 2, ascendingInteger));
      //System.out.println(Selector.<Integer>kmax(newColl2, 2, ascendingInteger));
      //System.out.println(Selector.<Integer>kmax(newColl3, 2, ascendingInteger));
      //System.out.println(Selector.<Integer>kmax(oneValColl, 1, ascendingInteger));
      //System.out.println(Selector.<Integer>kmax(twoValColl, 1, ascendingInteger));
   ...
   public static void kminExamples() {
      ...
      System.out.println(Selector.<Integer>kmin(lastCase, 5, ascendingInteger));
   }
